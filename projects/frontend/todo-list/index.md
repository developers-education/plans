# Техническое задание фронтенда "Todo List"
## 1. Описание проекта
...
![image](projects/frontend/todo-list/assets/20240830230342.png)
* Появляется модальное окно. Пользователь может ввести название задачи и создать задачу.

![image](projects/frontend/todo-list/assets/20240830224827.png)
...
![image](projects/frontend/todo-list/assets/20240830225632.png)
### 4.3 Пометка задачи
* Пользователь может нажать на галочку, чтобы пометить задачу как выполненную, или наоборот.

![image](projects/frontend/todo-list/assets/20240830225724.png)
### 4.4 Удаление задачи
* Пользователь может удалить задачу через нажатие на корзину.

![image](projects/frontend/todo-list/assets/20240830225847.png)
### 4.5 Просмотр задач
...
![image](projects/frontend/todo-list/assets/20240830230712.png)
### 4.6 Хранение задач
